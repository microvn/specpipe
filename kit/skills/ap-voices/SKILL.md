...
Signals for COMPLEX (ask user):
  ...
  - User explicit: "/ap-voices 3" or "/ap-voices full"
...
```
/ap-voices — <target>                    STATUS: <status>
══════════════════════════════════════════
Voices: <N> (<names>)
...
```
/ap-voices — <A> vs <B>                  STATUS: <status>
══════════════════════════════════════════
Voices: <N> (<names>)
...
```
/ap-voices — auth.ts refactor            STATUS: DONE_WITH_CONCERNS
══════════════════════════════════════════
⚠ Concerns:
...
{
  "questions": [{
    "question": "/ap-voices done. [N] disagreements, [N] critical findings.",
    "header": "What next?",
    "multiSelect": false,
    "options": [
      {"label": "Drill down — details on specific point"},
...
{
  "questions": [{
    "question": "/ap-voices done (self-spawn only — same model family).",
    "header": "What next?",
    "multiSelect": false,
    "options": [
...
{
  "questions": [{
    "question": "/ap-voices BLOCKED — [reason].",
    "header": "What next?",
    "multiSelect": false,
    "options": [
...
{
  "questions": [{
    "question": "/ap-voices needs context — [what's missing].",
    "header": "What next?",
    "multiSelect": false,
    "options": [
